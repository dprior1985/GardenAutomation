...
cursor.execute("select max(cast(Data as decimal(16,2))),min(cast(Data as decimal(16,2))),avg(cast(Data as decimal(16,2))),cast(Datenow as date) Datenow from ControlLog from SenorLog where SensorName = 'temp sensor 2'  order by cast(Datenow as date) ;" )
